...
function love.update(dt)
    ...
    if gameState == "playing" then
        ...
        if distEnemy < 15 then gameState = "gameover" end
...
function love.draw()
    ...
    if gameState == "start" then
        ...
        love.graphics.printf("APPUYEZ SUR [ENTRÉE] POUR COMMENCER", 0, love.graphics.getHeight()/2 + 40, love.graphics.getWidth(), "center")

        love.graphics.setColor(1, 1, 1, 0.6)
        love.graphics.printf("Z,Q,S,D pour bouger - Évitez le chien alien et récoltez les spaghettis !", 0, love.graphics.getHeight() - 60, love.graphics.getWidth(), "center")
        ...
        if gameState == "gameover" then
            ...
            love.graphics.printf("Appuyez sur [R] pour relancer", 0, love.graphics.getHeight() - 60, love.graphics.getWidth(), "center")
        end
    end
end